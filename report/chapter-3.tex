...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{Inflow_plt_alligned.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{AoA_plt_alligned.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{CL_CD_plt.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{a_plt_alligned.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{ap_plt_alligned.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{thrust_plt_alligned.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{tang_plt_alligned.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{ex_cos_plt.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{Thrust_convergence_plt.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.75\textwidth]{Thrust_conv_az_plt.png}
